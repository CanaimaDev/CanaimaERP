...
define('APP_DB_ENCRYPT', false); // Define the constant with a default value
define('APP_DB_DRIVER', 'mysqli'); // Define the constant with a default value
define('APP_DB_STRICTON', false); // Define the constant with a default value
